                  ...
                  <div class="container">
                    <div class="am-g">
                      <div class="am-u-md-10 am-u-sm-centered">
                        <h1 class="slide_simple--title">10-1200Kva全面发电系统解决之道</h1>
...
-->
  ...
  <div class="promo_detailed">
        ...
        <div class="am-g">
          ...
          <div class="am-u-md-6">
            <div class="promo_detailed--cta">
              ...
              <div class="promo_detailed-img am-show-sm-only" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/index/promo_detailed_bg.jpg');"></div>
            </div>
          </div>
    ...
    <div class="promo_detailed-img am-hide-sm-only" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/index/promo_detailed_bg.jpg');"></div>
  </div>
  <!--promo_detailed end-->
      ...
      <div class="container">
        <div class="am-g">
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_Microsoft.png" alt="" />
              <img class="am-active"  alt=""src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_Microsoft_active.png" alt="" />
            </a>
          </div>
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_qhdx.png" alt="" />
              <img class="am-active" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_qhdx_active.png" alt="" />
            </a>
          </div>
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_gmw.png" alt="" />
              <img class="am-active" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_gmw_active.png" alt="" />
            </a>
          </div>
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_gov.png" alt="" />
              <img class="am-active" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_gov_active.png" alt="" />
            </a>
          </div>
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_jl.png" alt="" />
              <img class="am-active" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_jl_active.png" alt="" />
            </a>
          </div>
          <div class="am-u-md-2 am-u-sm-4 customer-box">
            <a href="#">
              <img class="normal-logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_hx.png" alt="" />
              <img class="am-active" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/customer_logo_hx_active.png" alt="" />
            </a>
          </div>
        </div>
      </div>
  ...
  <div class="section" style="margin-top:0px;background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/pattern-light.png');">
    <div class="container">
      <!--index-container start-->
      <div class="index-container">
        <div class="am-g">
